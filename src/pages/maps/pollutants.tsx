...
export const siteTitle = 'GreenEra | Викиди забруднюючих речовин';

export const MapsPollutants = (): JSX.Element => {
    return (
        <Layout>
            <Head>
                    ...
                    <div className="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
                        <div className="lg:col-span-1">
                            ...
                            <div className="md:bg-white md:p-6 prose-lg text-gray-500">
                                <p>
                                    ...
                                    стаціонарних джерел забруднення по районах. Містить чотири шари:
                                </p>
                                <ul>
                                    <li>Викиди діоксида азоту (тис.тон);</li>
                                    <li>Викиди забруднюючих речовин (на одну особу. кг);</li>
                                    <li>Викиди забруднюючих речовин (тис.тон);</li>
                                    <li>
                                        Викиди забруднюючих речовин в атмосферне повітря (на одиницю
                                        площі. тон).
                                    </li>
                                </ul>
                        ...
                        <dl className="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-1 sm:gap-x-8 sm:gap-y-10 lg:mt-0 lg:col-span-2">
                            <div className="relative md:bg-white md:p-6">
                                <IframeResizer
                                    log
                                    src="//missioniz.maps.arcgis.com/apps/Embed/index.html?webmap=06b40c45819540e2be635fccf26361d8&extent=30.3048,50.3519,30.7875,50.6072&zoom=true&previewImage=false&scale=true&disable_scroll=true&theme=light"
                                    style={{
                                        minWidth: '100%',
                                        height: '600px'
                                    }}
