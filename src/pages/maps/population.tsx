...
export const siteTitle = 'GreenEra | Розподіл населення';

export const MapsPopulation = (): JSX.Element => {
    return (
        <Layout>
            <Head>
                    ...
                    <div className="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
                        <div className="lg:col-span-1">
                            ...
                            <div className="md:bg-white md:p-6 prose-lg text-gray-500">
                                <p>
                                    Кількість народжених та померлих, природний приріст та
                                    скорочення, по районах м.Києва (осіб). Містить чотири шари:
                                </p>
                                <ul>
                                    <li>Кількість народжених;</li>
                                    <li>Кількість померлих;</li>
                                    <li>Розподіл постійного населення на 1 січня;</li>
                                    <li>Природний приріст та скорочення (–) населення.</li>
                                </ul>
                                <div className="mt-8 flex">
                                    ...
                                    <div className="ml-3 inline-flex">
                                        <Link
                                            href={
                                                'https://hhra-missioniz.hub.arcgis.com/datasets/afbbff6ac0914740ad99bf51776de877'
                                            }>
                                            <a
                                                target={'_blank'}
                                                rel="noreferrer"
                        ...
                        <dl className="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-1 sm:gap-x-8 sm:gap-y-10 lg:mt-0 lg:col-span-2">
                            <div className="relative md:bg-white md:p-6">
                                <IframeResizer
                                    log
                                    src="//missioniz.maps.arcgis.com/apps/Embed/index.html?webmap=afbbff6ac0914740ad99bf51776de877&extent=30.276,50.3111,30.7587,50.5667&zoom=true&previewImage=false&scale=true&disable_scroll=true&theme=light"
                                    style={{
                                        minWidth: '100%',
                                        height: '600px'
                                    }}
