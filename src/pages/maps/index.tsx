                        ...
                        <div className="lg:col-span-1">
                            ...
                            <div className="md:bg-white md:p-6 prose-lg">
                                <p className="text-gray-500">
                                    міста Київ створено на основі технології ArcGIS. Дозволяють
                                    обробляти просторові дані і управляти ними. Є можливість обміну
                                    даними, доповнення та аналізу інформації. Це «Розумні карти» з
                                    безліччю функцій.
                                </p>
                            </div>
                        </div>
