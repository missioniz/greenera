...
const people = [
    {
        ...
        role: 'Доктор технічних наук (D.Sc.), Професор',
    ...
    {
        name: 'Дмитро Варавін',
        role: 'Кандидат технічних наук (Ph.D.)',
            ...
            <div className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
                <div className="text-center">
                    <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                        ...
                        <span className="block text-primary-600 xl:inline">захисту довкілля</span>
                    </h1>
                    <p className="mt-3 max-w-md mx-auto text-lg text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                        Ми – це спільнота експертів у сфері екологічної безпеки та зеленого
                        будівництва.
                    </p>
                </div>
            </div>
