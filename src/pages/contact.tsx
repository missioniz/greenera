                    ...
                    <div className="lg:pr-8">
                        <div className="max-w-md mx-auto sm:max-w-lg lg:mx-0">
                            ...
                            <p className="mt-4 text-lg text-gray-500 sm:mt-3">
                                Ви можете замовити консультації, домовитися про зустріч або задати
                                питання стосовно трансформації урбанізованого середовища в умовах
                                пандемічних загроз. Ми відповімо якнайшвидше!
                            </p>
                            <form
